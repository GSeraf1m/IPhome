...
public class Receita extends Comida implements Serializable {
    ...
    public String getFotoReceita() { return fotoReceita; }

    public void setFotoReceita(String fotoReceita) { this.fotoReceita = fotoReceita; }

    public ArrayList<Ingrediente> getListaIngredientes() { return listaIngredientes; }

    public void setListaIngredientes(ArrayList<Ingrediente> listaIngredientes) { this.listaIngredientes = listaIngredientes; }
}